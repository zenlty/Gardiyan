...
namespace CS_ClassLibraryTester
{
    ...
    class NYX_Theme : ThemeContainer154
    {
        ...
        protected override void PaintHook()
        {
            ...
            G.DrawString(Text, titleFont, new SolidBrush(Color.White), new Point(m - (textWidth / 2), 4));
    ...
    class NYX_Button : ThemeControl154
    {
        ...
        protected override void PaintHook()
        {
            ...
            //Background
            ColorBlend bg_cblend = new ColorBlend(3);
            bg_cblend.Colors[0] = Color.FromArgb(0, 10, 10);
            bg_cblend.Colors[1] = Color.FromArgb(0, 10, 10);
            bg_cblend.Colors[2] = Color.FromArgb(0, 10, 10);
            bg_cblend.Positions = new[] { 0, (float)0.6, 1 };
